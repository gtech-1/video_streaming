    ...
    <div className="min-h-screen bg-gray-50 relative overflow-x-hidden">
      ...
      >
        ...
        <div className="hidden xl:flex space-x-6 items-center">
          <button
            onClick={() => scrollToSection(heroRef, true)}
          ...
          <button
            onClick={() => scrollToSection(coursesRef, true)}
            className="hover:text-blue-400 transition"
          >
            Courses
          </button>
          <button
            onClick={() => scrollToSection(interactiveRef, true)}
            className="hover:text-blue-400 transition"
          >
            Interactive
          </button>
          <button
            onClick={() => scrollToSection(communityRef, true)}
            className="hover:text-blue-400 transition"
          >
            Community
          </button>
          <button
            onClick={() => scrollToSection(testimonialsRef, true)}
            className="hover:text-blue-400 transition"
          >
            Testimonials
          </button>
          <button
            onClick={() => scrollToSection(ctaRef, true)}
            className="hover:text-blue-400 transition"
          >
            Connect
          </button>
      ...
      >
        <div className="px-4 pb-4 space-y-2">
          <button
            ...
            className="block w-full py-2 text-left hover:text-blue-400 transition"
          >
            Home
          </button>
          <button
          ...
          <button
            onClick={() => navigate("/signUp")}
            className="block w-full py-2 text-left border-t border-gray-700 pt-2 mt-2 hover:text-blue-400"
          >
            Sign Up
          </button>
        </div>
        ...
        >
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p
              ...
              style={{ color: "#1f2937" }}
            >
              Empower yourself with interactive courses, real-time academic
              tracking, and a global community.
            </p>
            <div className="mt-8">
              {/* <button
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-base sm:text-lg max-w-3xl mx-auto mb-6 sm:mb-8 px-2 text-gray-700">
              ...
              and knowledge in various tech domains.
            </p>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-base sm:text-lg max-w-3xl mx-auto mb-6 sm:mb-8 px-2 text-gray-700">
              Engage in live workshops, group projects, and real-time Q&amp;A
              sessions that make learning dynamic.
            </p>
            <motion.img
      ...
      >
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-base sm:text-lg max-w-3xl mx-auto mb-6 sm:mb-8 px-2 text-gray-700">
              Connect with peers, mentors, and experts from around the world.
              Share insights, collaborate on projects, and grow together.
            </p>
            <motion.img
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6 px-2 sm:px-4 max-w-4xl mx-auto">
              <blockquote className="text-base sm:text-lg md:text-xl italic text-gray-700">
                "YourLMS transformed my academic journey. The dashboard kept me
                on track, and the courses opened new career doors."
              </blockquote>
              <blockquote className="text-base sm:text-lg md:text-xl italic text-gray-700">
                "I love the interactive approach—learning is engaging and the
                community support is outstanding."
              </blockquote>
              <blockquote className="text-base sm:text-lg md:text-xl italic text-gray-700">
                "From web dev to networking and cyber security, the variety of
                courses and real-time tracking helped me excel academically."
              </blockquote>
            </div>
          </motion.div>
        </div>
      ...
      <section ref={ctaRef} className="py-12 sm:py-16 md:py-20 bg-gray-100">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg max-w-3xl mx-auto mb-6 sm:mb-8 px-2 text-gray-700">
              Join thousands of learners in an LMS designed to empower, engage,
              and elevate your academic and professional journey.
            </p>
            <button
              onClick={() => navigate("/signUp")}
